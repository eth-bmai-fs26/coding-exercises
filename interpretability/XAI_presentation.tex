...
\begin{frame}{White-box vs.\ Black-box Models}
  ...
  \begin{columns}[T]
    \column{0.47\textwidth}
      \begin{block}{\faUnlock\ White-box models}
        \begin{itemize}
      ...
      \end{block}
    \column{0.47\textwidth}
      \begin{alertblock}{\faLock\ Black-box models}
        \begin{itemize}
  ...
  \end{columns}
  \vspace{0.5em}
  \begin{exampleblock}{Reality is a spectrum}
...
\begin{frame}{Local vs.\ Global Explanations}
  \begin{columns}[T]
    \column{0.47\textwidth}
      \begin{block}{\faSearchLocation\ Local explanations}
      ...
      \end{block}
    \column{0.47\textwidth}
      \begin{block}{\faGlobe\ Global explanations}
...
\begin{frame}{SHAP --- Core Idea}
  \begin{block}{Game-theory foundation}
