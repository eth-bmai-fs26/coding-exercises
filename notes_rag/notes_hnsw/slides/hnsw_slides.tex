...
\bigskip
\begin{insightbox}
  \bfgold{5 comparisons} vs.\ 6 for linear scan. Express lanes skip most elements.
\end{insightbox}
...
% ------ Slide: Layered Hierarchy ------
\begin{frame}{Layered Hierarchy}
...
\begin{enumerate}
  \item \bfcoral{Greedy descent}\\
    {\small layers $L \to 1$: cheap, no beam}

  \bigskip
  \item \bfpurple{Beam search on layer 0}\\
    {\small find $\ef$ candidates among all $N$ elements}
